    ...
    <>
      <section className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          {/* Card 1 — Crewshoot Edition 1 Reel */}
          <motion.div 
          ...
          >
            <div className="text-[10px] font-black text-accent uppercase tracking-[0.2em] mb-4 bg-accent/10 w-fit px-3 py-1 rounded">CREWSHOOT EDITION</div>
            <h3 className="text-3xl font-heading font-extrabold mb-4 uppercase italic">1 Instant Reel</h3>
            ...
            <a 
              href="https://wa.me/916281998732?text=Hey%20Crewshoot!%20I%20want%20Crewshoot%20Edition%201%20Reel%20Rs1899"
              target="_blank"
              rel="noreferrer"
          ...
          {/* Card 2 — Crewshoot Edition 2 Reels (Most Popular) */}
          <motion.div 
            initial={{ opacity: 0, x: 30 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            transition={{ delay: 0.1 }}
            className="bg-gradient-to-b from-accent/20 to-transparent border-2 border-accent p-8 rounded-[2rem] relative overflow-hidden shadow-[0_20px_50px_rgba(245,166,35,0.15)] flex flex-col group scale-105 z-10"
          >
            ...
            <div className="text-[10px] font-black text-accent uppercase tracking-[0.2em] mb-4 bg-accent/20 w-fit px-3 py-1 rounded">CREWSHOOT EDITION</div>
            <h3 className="text-3xl font-heading font-extrabold mb-4 uppercase italic">2 Instant Reels</h3>
            <div className="mb-8 flex items-baseline gap-2">
              <span className="text-4xl font-black text-white">₹3,899</span>
            ...
            <a 
              href="https://wa.me/916281998732?text=Hey%20Crewshoot!%20I%20want%20Crewshoot%20Edition%202%20Reels%20Rs3899"
              target="_blank"
              rel="noreferrer"
